...
,===
A[o], B[i], A-B, B[o], C[i], B-C, results ABC
...
0,1,-1 (under-supply),1,0,+1 (over-supply) ,under-supply
1,0,+1 (over-supply) ,1,1, 0 (match)       ,over-supply
1,0,+1 (over-supply) ,0,1,-1 (under-supply),match       
1,0,+1 (over-supply) ,0,1,+1 (over-supply) ,over-supply
,===
