...
: xor ( a b -- out ) 2dup swap [ not and ] 2bi@ or ;       ! <1>
...
: test-xor ( seq -- seq ) [ [ xor ] with-datastack ] map ; ! <3>
----

<1> ++https://docs.factorcode.org/content/word-2bi__at__,kernel.html++
<2> https://docs.factorcode.org/content/word-all-selections,math.combinatorics.html
<3> https://docs.factorcode.org/content/word-map,sequences.html
