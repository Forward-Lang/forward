...
* javascript
  https://learnxinyminutes.com/docs/javascript/[cheatsheet] 
  https://replit.com/languages/javascript[online] 
* bash
  https://learnxinyminutes.com/docs/bash/[cheatsheet] 
  https://replit.com/languages/bash[online] 
* lua
  https://learnxinyminutes.com/docs/lua/[cheatsheet] 
  https://replit.com/languages/lua[online] 
