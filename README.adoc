...
* Axiomatic semantics
** <<Hoare%20triples>>: Pre- and Post-conditions. Possibly also while-conditions aka invariants.
** <<Dependent%20types>>
...
* [[Hoare%20triples]] https://en.wikipedia.org/wiki/Hoare_logic#Hoare_triple
* [[Waterfall]] https://en.wikipedia.org/wiki/Waterfall_model#Model
* [[Dependent%20types]] https://en.wikipedia.org/wiki/Dependent_type
