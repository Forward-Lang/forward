...
| Vision | That due to its simplicity it sees widespread use whithin its problem domains, remaining in the background ready to be used, like the shell, but as effective as a scalpel. 
| Values | 
