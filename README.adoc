...
* Simplicity, through the removal of unnecessities. Being simplex footnote:[https://www.infoq.com/presentations/Simple-Made-Easy/] by reducing interleaving complexity.
