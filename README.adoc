...
link:https://github.com/Forward-Lang/forward/edit/main/{docname}.adoc[Edit this page on GitHub]
...
== <<Waterfall>> process | https://github.com/Forward-Lang/forward/milestones?direction=asc&sort=title[Milestones]
...
* [[[analysis-paralysis]]] xref:knowledge-base.adoc#analysis-paralysis-wikipedia[]
